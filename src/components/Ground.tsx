...
export function Ground() {
  return (
    <>
      ...
      <Grid position={[0, GROUND_Y + 0.001, 0]} args={[40, 40]} cellSize={0.5} cellThickness={0.5} cellColor="#6f6f6f" sectionSize={2} sectionThickness={1} sectionColor="#004242" fadeDistance={30} fadeStrength={1} infiniteGrid />

      {/* Pedestal */}
      <mesh position={[0, PEDESTAL_CENTER_Y, 0]} receiveShadow castShadow>
        <cylinderGeometry args={[PEDESTAL_RADIUS, PEDESTAL_RADIUS, PEDESTAL_THICKNESS, 128]} />
        <meshStandardMaterial color="#c3c3c3" roughness={0.8} metalness={0.1} />
      </mesh>

      {/* Central pivot pillar */}
      <mesh position={[0, PILLAR_CENTER_Y, 0]}>
        <cylinderGeometry args={[0.035, 0.04, PILLAR_HEIGHT, 12]} />
